...
# -*- coding: utf-8 -*-
"""
4KPorno.XXX 爬虫源 —— v21 (TVBox 兼容修复版)
修复内容:
  - SSL 证书验证绕过
...
class Spider(BaseSpider):
    ...
    def detailContent(self, ids):
        ...
        if video_block:
            ...
            <source[^>]*src=['"]([^'"]*)['"][^>]*label=['"]([^'"]*)['"]"
            '''
            sources = re.findall(pattern, block)
            if sources:
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="4KPorno.XXX 爬虫源 v21")
